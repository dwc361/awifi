		...
		<div class="leftPart">
			<div class="left col-md-12 col-lg-12 col-sm-12">
				...
				<div class="Hchart">
					...
					<!--<div id="textname" style="top: 5.4rem;">
						<ul style="font-size: 1.4rem;">
							<li> <i style="background: #367bdb;"></i>正常：<i id="areaspline1">343242424</i> <span></span></li>
							<li><i style="background: #d9a831;"></i>故障：<i id="areaspline2">54654645654</i><span></span></li>
							<li><i style="background: #42aeb8;"></i>离线：<i id="areaspline3">3242435</i><span></span></li>
						</ul>
					</div>-->
				</div>
			</div>
