...
<script type="text/javascript" src="${basePath }/ems_common/js/Letv.SelectableTable.js"></script>
<script type="text/javascript" src="${basePath }/ems_common/js/Letv.validate.js"></script>
...
<script type="text/javascript" src="${basePath }/ems_common/js/com.letv.PageBar.js"></script>
<script type="text/javascript" src="${basePath }/ems_common/plugins/fileinput-master/js/fileinput.js" ></script>
<script type="text/javascript" src="${basePath }/ems_common/plugins/fileinput-master/js/fileinput_locale_zh.js" ></script>

<script type="text/javascript" src="${basePath}/ems_common/plugins/fullcalendar-2.2.7/lib/moment.min.js"></script>
<script type="text/javascript" src="${basePath}/ems_common/plugins/fullcalendar-2.2.7/lib/jquery-ui.custom.min.js"></script>
<script type="text/javascript" src="${basePath}/ems_common/plugins/fullcalendar-2.2.7/fullcalendar.js"></script>
<c:if test="${locale.language eq 'zh' }">
<script type="text/javascript" src="${basePath}/ems_common/plugins/fullcalendar-2.2.7/lang/zh-cn.js"></script>
</c:if>
<link href='${basePath}/ems_common/plugins/fullcalendar-2.2.7/fullcalendar.css' rel='stylesheet' />
<link href='${basePath}/ems_common/plugins/fullcalendar-2.2.7/fullcalendar.print.css' rel='stylesheet' media='print' />
<link rel="stylesheet" href="${basePath}/common/js/jquery_timepicker_addon/jquery-ui-timepicker-addon.min.css" />

<script type="text/javascript" src="${basePath }/ems_common/js/com.letv.CheckboxValidate.js"></script>

<link rel="stylesheet" href="${basePath }/ems_common/css/vendor.css">
<link rel="stylesheet" href="${basePath }/ems_common/bootstrap/css/bootstrap-theme.css">
<link rel="stylesheet" href="${basePath }/ems_common/bootstrap/css/bootstrap.css">
<link rel="stylesheet" href="${basePath }/ems_common/css/app.css">
<link rel="stylesheet" href="${basePath }/ems_common/plugins/fileinput-master/css/fileinput.css" media="all" rel="stylesheet" type="text/css">

<link rel="stylesheet" type="text/css" href="${basePath}/ems_common/css/error.css" />
<link rel="stylesheet" href="${basePath}/ems_common/css/hint/hint.css" />
<!--[if lt IE 7]>
