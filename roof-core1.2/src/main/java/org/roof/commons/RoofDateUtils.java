...
public class RoofDateUtils {
	...
	public static String[] MONTH_NAME_CN = new String[] { "一月", "二月", "三月", "四月", "五月", "六月", "七月", "八月", "九月", "十月",
			"十一月", "十二月" };
	...
	public static Date stringToDate(String dateStr, String[] patterns) throws ParseException {
		if (StringUtils.isBlank(dateStr)) {
			return null;
		}
		return org.apache.commons.lang.time.DateUtils.parseDate(dateStr, patterns);
	}

	public static String dateToString(Date date) {
		return dateToString(date, DATE_TIME_EXPRESSION_GENERAL);
	}
