...
public class RoofDaoSupport extends RoofAbstractDao {
	...
	public void resetSession(Object value) {
		...
		if (value instanceof HibernateProxy) {// hibernate代理对象
			...
			if (initializer.getSession() == null || initializer.getSession().isClosed()) {
	 ...
	 * @return 容器中通用的基本操作类
	 */
	public static RoofDaoSupport getDao() {
		return CurrentSpringContext.getBean("roofDaoSupport", RoofDaoSupport.class);
	}
	...
	public SqlDescription getNamedSql(String statementName, Object parameterObject) {
		SqlMapClientImpl sqlmap = (SqlMapClientImpl) super.sqlMapClientTemplate.getSqlMapClient();
		...
		String sqlStr = sql.getSql(statementScope, parameterObject);
		return new SqlDescription(sqlStr, parameters);
	}
	...
	public Serializable save(Object entity) {
		return super.hibernateTemplate.save(entity);
	}
	...
	public void delete(Object entity) {
		super.hibernateTemplate.delete(entity);
	}
	...
	public void deleteByExample(Object exampleEntity) {
		...
		super.hibernateTemplate.deleteAll(entities);
	}
	...
	public <T> T load(Class<T> entityClass, Serializable id, LockMode lockMode) {
		return super.hibernateTemplate.load(entityClass, id, lockMode);
	}
	...
	public <T> List<T> loadAll(Class<T> entityClass) {
		return super.hibernateTemplate.loadAll(entityClass);
	}
	...
	public List<?> findForList(String queryString, Object value) {
		return super.hibernateTemplate.find(queryString, value);
	}
	...
	public List<?> findForList(String queryString, Object... values) {
		return super.hibernateTemplate.find(queryString, values);
	}
	...
	public Object executeForObject(final String queryString) {
		return this.executeForObject(queryString, ArrayUtils.EMPTY_OBJECT_ARRAY);
	}
	...
	public Object executeForObject(final String queryString, final Object... values) {
		...
		return super.hibernateTemplate.execute(new HibernateCallback<Object>() {
	...
	public Object findSingle(String queryString, Object... values) throws DaoException {
		...
		if (result.size() > 1) {
			throw new DaoException("查询语句:[" + queryString + "] 数据库唯一记录出错:期望是一条记录,但是查询到多条");
		}
		return result.get(0);
	}
	...
	public List<?> findForList(final String queryString, final int firstResult, final int maxResults) {
		return this.findForList(queryString, firstResult, maxResults, new Object[] {});
	}
	 ...
	 * @return 查询语句返回的结果
	 */
	public List<?> findForList(final String queryString, final int firstResult, final int maxResults, final Object value) {
		return this.findForList(queryString, firstResult, maxResults, new Object[] { value });
	}
	...
	public List<?> findForList(final String queryString, final int firstResult, final int maxResults,
		...
		List<?> resList = hibernateTemplate.execute(new HibernateCallback<List<?>>() {
	...
	public List<?> findByExample(Object exampleEntity) {
		return super.hibernateTemplate.findByExample(exampleEntity);
	}
	...
	public List<?> findByExample(Object exampleEntity, int firstResult, int maxResults) {
		return super.hibernateTemplate.findByExample(exampleEntity, firstResult, maxResults);
	}
	...
	public Object findByExampleSingle(Object exampleEntity) throws DaoException {
		List<?> list = super.hibernateTemplate.findByExample(exampleEntity);
		if (list.size() == 1) {
			return list.get(0);
		}
		if (list.size() == 0) {
		...
		throw new DaoException("查询语句:[" + exampleEntity.toString() + "] 数据库唯一记录出错:期望是一条记录,但是查询到多条");
	}
	...
	public <T> T findEqualSingle(FindEqualBuilder criterions) throws DaoException {
		...
		throw new DaoException("查询:[" + criterions.toString() + "] 数据库唯一记录出错:期望是一条记录,但是查询到多条");
	}
	...
	public <T> T findEqualSingle(Class<T> entityClass, Object paramObj, Map<String, String> mapping, String[] ignores)
			throws DaoException {
		FindEqualBuilder findEqualBuilder = FindEqualBuilder.getInstance().setEntityClass(entityClass)
				.setParamObj(paramObj).setMapping(mapping).setIgnores(ignores);
	...
	public long findEqualCount(FindEqualBuilder criterions) {
		criterions.init();
		final DetachedCriteria detachedCriteria = DetachedCriteria.forClass(criterions.getEntityClass());
	...
	public <T> List<T> findEqual(FindEqualBuilder criterions, int firstResult, int maxResults) {
		criterions.init();
		DetachedCriteria detachedCriteria = DetachedCriteria.forClass(criterions.getEntityClass());
		...
		@SuppressWarnings("unchecked")
		List<T> result = this.hibernateTemplate.findByCriteria(detachedCriteria, firstResult, maxResults);
		return result;
	}
	...
	public <T> List<T> findEqual(Class<T> entityClass, Object paramObj, Map<String, String> mapping, int firstResult,
			int maxResults) {
		return findEqual(entityClass, paramObj, mapping, null, firstResult, maxResults);
	}
	...
	public <T> List<T> findEqual(Class<T> entityClass, Object paramObj, String[] ignores, int firstResult,
			int maxResults) {
		return findEqual(entityClass, paramObj, null, ignores, firstResult, maxResults);
	}
	...
	public <T> List<T> findEqual(Class<T> entityClass, Object paramObj, int firstResult, int maxResults) {
		return findEqual(entityClass, paramObj, null, null, firstResult, maxResults);
	}
	...
	public void update(Object entity) {
		super.hibernateTemplate.update(entity);
	}
	...
	public Object updateIgnoreNull(Object entity, Serializable id, String[] props) {
		...
		try {
			...
			@SuppressWarnings("unchecked")
			Set<Entry<String, Object>> newSet = PropertyUtils.describe(entity).entrySet();
			for (Entry<String, Object> newEntry : newSet) {
				...
				PropertyUtils.setProperty(old, newEntry.getKey(), newEntry.getValue());
			}
		} catch (Exception e) {
	...
	public void saveOrUpdate(Object entity) {
		super.hibernateTemplate.saveOrUpdate(entity);
	}
	...
	public void saveOrUpdateAll(Collection<?> entities) {
		super.hibernateTemplate.saveOrUpdateAll(entities);
	}
	...
	public List<?> selectByValueBean(String queryString, Object valueBean) {
		return super.hibernateTemplate.findByValueBean(queryString, valueBean);
	}
	...
	public List<?> selectForList(String statementName) {
		return super.sqlMapClientTemplate.queryForList(statementName);
	}
	...
	public List<?> selectForList(String statementName, Object parameterObject) {
		return super.sqlMapClientTemplate.queryForList(statementName, parameterObject);
	}
	...
	public List<?> selectForList(String statementName, int skipResults, int maxResults) {
		return super.sqlMapClientTemplate.queryForList(statementName, skipResults, maxResults);
	}
	...
	public List<?> selectForList(String statementName, Object parameterObject, int skipResults, int maxResults) {
		return super.sqlMapClientTemplate.queryForList(statementName, parameterObject, skipResults, maxResults);
	}
	...
	public Object selectForObject(String statementName) {
		return super.sqlMapClientTemplate.queryForObject(statementName);
	}
	...
	public Object selectForObject(String statementName, Object parameterObject) {
		return super.sqlMapClientTemplate.queryForObject(statementName, parameterObject);
	}
	...
	public List<Map<String, Object>> selectForCamelCaseMap(String statementName) throws DaoException {
		List<?> resultList = sqlMapClientTemplate.queryForList(statementName);
