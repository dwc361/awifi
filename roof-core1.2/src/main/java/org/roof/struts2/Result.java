...
public class Result {
	...
	public static JsonConfig createJsonConfig(final Map<Class<?>, String[]> ignoreProperties) {
		JsonConfig cfg = new JsonConfig();
		cfg.setJsonPropertyFilter(new PropertyFilter() {
			public boolean apply(Object source, String name, Object value) {
				for (Entry<Class<?>, String[]> entry : ignoreProperties.entrySet()) {
					if (ClassUtils.isAssignable(source.getClass(), entry.getKey())) {
