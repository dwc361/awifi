...
<script type="text/javascript"
	src="${basePath }/roof-web/web/dictionary/js/dictionary_detail.js"></script>
<title></title>
</head>
<body>
	<div class="ui-table-toolbar">
		...
		<ul class="yright">
			<li><a
				href="${basePath }/dictionaryAction/create_page.action?parentId=${dictionary.id}"><i
					class="icon-plus icon-large"></i> 新增</a></li>
			<li><a id="delSrcBtn"
				href="${basePath }/dictionaryAction/delete.action?id=${dictionary.id }"><i
	...
	<form id="mainForm"
		action="${basePath }/dictionaryAction/update.action" method="post">
		...
		<table border="0" cellpadding="0" cellspacing="1" class="ui-table"
			...
			<tr>
				...
				<td><input type="text" readonly="readonly" name="type"
					style="width: 300px;" value="${dictionary.type }" /></td>
			</tr>
			<tr>
				<td class="ui-table-header2" style="text-align: center;" width="20%">值
					:</td>
				<td><input type="text" readonly="readonly" name="val"
