...
<body>
	<div class="login_wraper">
		...
		<form id="login_form" action="${basePath}/j_spring_security_check"
			method="post">
			<div class="login">
				<ul class="content">
					<li>工&nbsp;&nbsp;&nbsp;号：&nbsp;<input name="j_username"
						type="text" id="j_username"
						style="width: 150px; padding: 3px 5px; border: #82BBD9 solid 1px;"
						value="admin" />
					</li>
					<li>密&nbsp;&nbsp;&nbsp;码：&nbsp;<input name="j_password"
						type="password" id="j_password"
						style="width: 150px; padding: 3px 5px; border: #82BBD9 solid 1px;"
						value="123456abc" />
					</li>
				</ul>
