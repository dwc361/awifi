...
@SequenceGenerator(name = "SEQ_S_DYNAMIC_TO_STATIC", sequenceName = "SEQ_S_DYNAMIC_TO_STATIC")
public class DynamicToStatic {
	...
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SEQ_S_DYNAMIC_TO_STATIC")
	public Long getId() {
		return id;
	}
