...
public class BaseUserContext {
	 ...
	 * @param userDetails
	 */
	public static void putCurrentUser(UserDetails userDetails) {
		HttpServletRequest request = WebUtils.getRequest();
		// 从spring容器中获取UserDetailsService(这个从数据库根据用户名查询用户信息,及加载权限的service)
		UserDetailsService userDetailsService = (UserDetailsService) CurrentSpringContext.getBean("userDetailsService");
	 ...
	 * @return 角色ID数组
	 */
	public static Long[] getUserRoles() {
