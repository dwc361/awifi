...
@SequenceGenerator(name = "seq_sys_fileInfo", sequenceName = "SEQ_SYS_FILEINFO", initialValue = 1)
public class FileInfo implements Serializable{
	...
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seq_sys_fileInfo")
	public Long getId() {
		return id;
	}
