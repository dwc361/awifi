...
<script type="text/javascript" src="${basePath }/roof-web/web/menu/js/menu_index.js"></script>
...
<body>
	...
	<div style="width: 78%; height: 100%; float: right;">
		<iframe src="${basePath }/menuAction!detail.action?id=1" frameborder="0" scrolling="auto" width="100%" height="650px"></iframe>
	</div>
</body>
</html>