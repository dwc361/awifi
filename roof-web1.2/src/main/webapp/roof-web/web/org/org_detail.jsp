...
<body>
	<div class="ui-table-toolbar">
		...
		<ul class="yright">
			<li><a href="${basePath }/orgAction!create_page.action?parentId=${org.org_id}"><i class="icon-plus icon-large"></i>
					新增</a></li>
			<c:if test="${org.leaf }">
				<li><a id="delSrcBtn" href="${basePath }/orgAction!delete.action?id=${org.org_id }"><i
