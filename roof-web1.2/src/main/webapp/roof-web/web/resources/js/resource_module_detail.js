$(document).ready(function() {
	...
	var module_path_input = $('input[name="module.path"]');
	var module_pattern_input = $('input[name="module.pattern"]');
	var lvl = $('input[name="module.lvl"]').val();
	$('a[name="addresource"]').click(function() {
		$.post($(this).attr('href'), {}, function(d) {
			if (d.state == 'success') {
				ROOF.Utils.alert(d.message, function() {
					// window.location.href = "resourceAction!detail.action?id="
					// + d.data.id;
	...
	$('input[name="module.identify"]').change(function() {
