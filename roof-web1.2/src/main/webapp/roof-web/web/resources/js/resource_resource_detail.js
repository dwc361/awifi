$(document).ready(function() {
	...
	var privilege_path_input = $('input[name="privilege.path"]');
	var privilege_pattern_input = $('input[name="privilege.pattern"]');
	...
	$('input[name="privilege.identify"]').change(function() {
