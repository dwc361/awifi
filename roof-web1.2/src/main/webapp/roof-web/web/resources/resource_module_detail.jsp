...
<script type="text/javascript" src="${basePath }/roof-web/web/resources/js/resource_module_detail.js"></script>
<title></title>
</head>
<body>
	<div class="ui-table-toolbar">
		...
		<ul class="yright">
			<li><a name="addresource" href="${basePath }/resourceAction!create.action?parentId=${resource.id}&type=module"><i
			...
			<c:if test="${resource.leaf }">
				<li><a id="delSrcBtn" href="${basePath }/resourceAction!delete.action?id=${resource.id }"><i
						class="icon-trash icon-large"></i> 删除</a></li>
			</c:if>
			<li><a id="saveBtn" href="#"><i class="icon-save icon-large"></i> 保存</a></li>
		</ul>
	</div>
	<form id="mainForm" action="${basePath }/resourceAction!updateModule.action" method="post">
		<input id="resource_leaf" name="module.leaf" type="hidden" value="${resource.leaf }">
		<table border="0" cellpadding="0" cellspacing="1" class="ui-table" width="100%">
			<tr>
				<td class="ui-table-header2" style="text-align: center;" width="20%">模块名: <input name="module.id" type="hidden"
					value="${resource.id }" />
				</td>
				<td><input type="text" name="module.name" style="width: 300px;" value="${resource.name }" /></td>
			</tr>
			<tr>
				<td class="ui-table-header2" style="text-align: center;" width="20%">顺序:</td>
				<td><input type="text" style="width: 300px;" name="module.seq" value="${resource.seq }" /></td>
			</tr>
			<tr>
				<td class="ui-table-header2" style="text-align: center;" width="20%">等级:</td>
				<td><input type="text" style="width: 300px;" name="module.lvl" value="${resource.lvl }" readonly="readonly" />
				</td>
			</tr>
			<c:if test="${resource.lvl != 0 }">
				<tr>
				...
				<tr>
					...
					<td><input type="text" name="module.identify" style="width: 300px;" value="${resource.identify }" /></td>
				</tr>
				<tr>
					<td class="ui-table-header2" style="text-align: center;" width="20%">描述:</td>
					<td><input type="text" name="module.description" style="width: 300px;" value="${resource.description }" /></td>
				</tr>
			</c:if>
			<tr>
				<td class="ui-table-header2" style="text-align: center;" width="20%">路径:</td>
				<td><input type="text" name="module.path" style="width: 300px;" value="${resource.path }" /> <input
					id="parent_path" type="hidden" value="${resource.parent.path }" /></td>
			</tr>
			<tr>
				<td class="ui-table-header2" style="text-align: center;" width="20%">规则:</td>
				<td><input type="text" name="module.pattern" style="width: 300px;" value="${resource.pattern }" /> <input
					type="hidden" id="parent_pattern" value="${resource.parent.pattern }" /></td>
			</tr>
		</table>
	</form>
</body>
