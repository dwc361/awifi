	...
	<form id="mainForm" action="${basePath }/resourceAction!updatePrivilege.action" method="post">
		...
		<table border="0" cellpadding="0" cellspacing="1" class="ui-table" width="100%">
			<tr>
				...
				<td><select name="privilege.format" style="width: 300px;">
						<c:choose>
			...
			<tr>
				...
				<td><textarea cols="80" rows="10" name="privilege.returnExample">${resource.returnExample }</textarea>
				</td>
			</tr>
			<tr>
				<td class="ui-table-header2" style="text-align: center;" width="20%">备注:</td>
				<td><textarea cols="80" rows="10" name="privilege.remark">${resource.remark }</textarea>
				</td>
			</tr>
			  -->
		</table>
