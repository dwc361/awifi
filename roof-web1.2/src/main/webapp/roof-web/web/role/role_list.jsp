...
<script type="text/javascript" src="${basePath }/roof-web/web/role/js/role_list.js"></script>
...
<body>
	...
	<form id="mainForm" action="${basePath }/roleAction!list.action" method="post">
	...
	<div class="ui-table-toolbar">
		...
		<ul class="yright">
			<li><a href="roleAction!create_page.action?currentPage=${page.currentPage }"><i class="icon-plus icon-large"></i>
					新增</a></li>
			<li><a id="updateBtn" href="roleAction!update_page.action?currentPage=${page.currentPage }"><i
					class="icon-edit icon-large"></i> 修改</a>
			</li>
			<li><a id="deleteBtn" href="roleAction!delete.ajax"><i class="icon-trash icon-large"></i> 删除</a>
			</li>
		</ul>
	</div>
	<table border="0" cellpadding="0" cellspacing="1" class="ui-table" width="100%">
