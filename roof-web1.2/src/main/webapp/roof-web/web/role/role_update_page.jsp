...
<script type="text/javascript" src="${basePath}/roof-web/web/role/js/role_create_page.js"></script>
	...
	<div class="ui-table-toolbar">
		...
		<ul class="yright">
			...
			<c:if test="${currentPage != null }">
				<li><a id="backbtn" href="${basePath }/roleAction!list.action?currentPage=${currentPage}"><i class="icon-reply icon-large"></i>
						返回</a>
				</li>
			</c:if>
		</ul>
	</div>
	<form id="mainForm" action="${basePath }/roleAction!update.action" method="post">
