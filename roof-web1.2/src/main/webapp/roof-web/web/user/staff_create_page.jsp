	...
	<div class="ui-table-toolbar">
		...
		<ul class="yright">
			...
			<c:if test="${currentPage != null }">
				<li><a id="backBtn" href="${basePath }/staffAction!list.action?currentPage=${currentPage}"><i class="icon-reply icon-large"></i>
						返回</a></li>
			</c:if>
		</ul>
	</div>
	<form id="mainForm" action="${basePath }/staffAction!create.action" method="post">
		<%@include file="staff_form.jsp"%>
	</form>
</body>
</html>