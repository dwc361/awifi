 ...
 */
@Service
public class Mix_JHL_Chart_PullData implements IPullData<Map>, InitializingBean{
	private Logger log = Logger.getLogger(Mix_JHL_Chart_PullData.class);
	...
	public void afterPropertiesSet() throws Exception {
		...
		method = PropertiesUtil.getPorpertyString("DataCenter.method.queryActivateDevByArea");
