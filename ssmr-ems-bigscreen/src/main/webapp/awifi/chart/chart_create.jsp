...
<body>
	<div class="container layout-wraper" style="width: 100%;">
		<form id="bigscreen_chart_form" action="${basePath}/awifi/chartAction/create.json" method="post">
			<div class="row">
				<div class="col-xs-12 layout-header">
					<button type="submit" class="btn btn-default">提交</button>
					<button id="bigscreen_chart_update_close_btn" class="btn btn-default">取消</button>
				</div>
			</div>
