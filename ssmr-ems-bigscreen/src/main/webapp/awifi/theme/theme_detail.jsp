...
<script type="text/javascript">
	$(document).ready(function() {
		ROOF.Utils.readonlyForm($("#bigscreen_theme_form"));
	});
</script>
</head>
<body>
	<div class="container layout-wraper" style="width: 912px; position: absolute; top: 10px; left: 10px;">
		<form id="bigscreen_theme_form" action="" method="post">
			<div class="row">
				<div class="col-xs-12 layout-header">
					<button id="bigscreen_theme_detail_close_btn" class="btn btn-default">取消</button>
				</div>
			</div>
