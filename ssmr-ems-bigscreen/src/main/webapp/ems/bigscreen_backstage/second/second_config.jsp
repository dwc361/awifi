...
<script src="${basePath}/ems/bigscreen_backstage/second/js/second_config.js"></script>
</head>
...
<script src="${basePath}/ems/bigscreen_backstage/second/js/second_config_react_component.js"></script>
</html>