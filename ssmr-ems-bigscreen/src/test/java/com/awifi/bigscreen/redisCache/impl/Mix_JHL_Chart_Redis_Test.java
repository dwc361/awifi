...
public class Mix_JHL_Chart_Redis_Test extends AbstractJUnit4SpringContextTests {
	
	@Resource
	private IRedisCache redisZSetCache;
	@Resource(name="mix_JHL_Chart_DataAcquisition")
	private IDataAcquisition acquisition;
	@Resource(name="mix_JHL_Chart_DataTransform")
...
//		System.out.println(s3);
	...
	public void testCreateOrUpdateCache() {
		redisZSetCache.createOrUpdateCache(AwifiConstants.Redis_Key_Mix_JHL_Chart, acquisition, "{'key':'value'}");
	}
}