...
<body>
	...
	<div class="main">
		<c:set var="submit_url" value="uac_account_whiteListAction!update.ajax" />
		<%@include file="/uac/account/whiteList/whiteList_form.jsp"%>
		<div class="btnBox">
			<a id="backBtn" href="${basePath}/uac_account_whiteListAction!list.action">
				<p class="sBtn">返回</p>
