...
$(document).ready(function() {
	...
	var setting = {
			async : {
				enable : true,
				url : "dictionaryAction!readVal.ajax?val=REGION",
				autoParam : ["val=type"]
			},
			view : {
				selectedMulti : false
			...
			callback : {
				onClick : function(event, treeId, node) {
					...
					$('iframe').attr("src", "uac_authorization_appAction!list.action?app.region.id=" + node.id);
				},
...
<body>
	...
	<div class="main">
		...
		<div class="conBox">
			<iframe src="${basePath }/uac_authorization_appAction!list.action" frameborder="0" scrolling="auto" width="100%"></iframe>
		</div>
	</div>
</body>
</html>