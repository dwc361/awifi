...
public class ${alias?cap_first}Action extends RoofActionSupport {
	...
	public String list() {
		...
		loadCommonData();
		result = "/${sysName}/${packageArr[packageArr?size-2]}/${packagePath?substring(packagePath?last_index_of(".")+1)}/${alias}_list.jsp";
		return JSP;
	}
	...
	public String create_page() {
		...
		loadCommonData();
		result = "/${sysName}/${packageArr[packageArr?size-2]}/${packagePath?substring(packagePath?last_index_of(".")+1)}/${alias}_create.jsp";
		return JSP;
	}
	...
	public String update_page() throws Exception {
		...
		super.addParameter("${alias}_paramString", super.getParamString(WebUtils.getRequest()));
		loadCommonData();
		result = "/${sysName}/${packageArr[packageArr?size-2]}/${packagePath?substring(packagePath?last_index_of(".")+1)}/${alias}_update.jsp";
		return JSP;
	}
	...
	public String detail_page() throws Exception {
		...
		super.addParameter("${alias}_paramString", super.getParamString(WebUtils.getRequest()));
		loadCommonData();
		result = "/${sysName}/${packageArr[packageArr?size-2]}/${packagePath?substring(packagePath?last_index_of(".")+1)}/${alias}_detail.jsp";
		return JSP;
	}
