...
function GooCalendar(InputID,property){
	...
	temp="<div class='top'><b class='arrow'><div class='left'></div></b><b class='arrow' style='float:right;'><div class='right'></div></b></div>"+
		...
		"<div class='bottom'><div class='cal_btn'>今天</div><div class='time'></div><div class='cal_btn' style='float:right'>清空</div></div>";
	...
	if(property.week)
		...
		this.$week=['日','一','二','三','四','五','六'];//从左至右，周日，周一。。。。。。周六
	temp="";
	...
	this.$div.children(".bottom").children("div:eq(2)").bind("click",{inthis:this},function(e){e.data.inthis.cancel();$("#"+InputID).val("");});
...
jQuery.extend({
	createGooCalendar : function(InputId, property) {
		var c = new GooCalendar(InputId, property);
